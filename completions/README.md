...
**Alternative (Static):** Use `completions/track.bash` for static completions without dynamic data.
...
**Alternative (Static):** Use `completions/_track` (generated by `track completion zsh`) for static completions.
