...
complete -c track -n "__fish_track_needs_command" -f -a "_complete" -d 'Output completion candidates (hidden, for shell completion scripts)'
complete -c track -n "__fish_track_needs_command" -f -a "config" -d 'Configuration management'
...
complete -c track -n "__fish_track_using_subcommand todo; and not __fish_seen_subcommand_from add list update done delete next help" -s h -l help -d 'Print help'
complete -c track -n "__fish_track_using_subcommand todo; and not __fish_seen_subcommand_from add list update done delete next help" -f -a "add" -d 'Add a new TODO'
complete -c track -n "__fish_track_using_subcommand todo; and not __fish_seen_subcommand_from add list update done delete next help" -f -a "list" -d 'List TODOs'
complete -c track -n "__fish_track_using_subcommand todo; and not __fish_seen_subcommand_from add list update done delete next help" -f -a "update" -d 'Update TODO status'
complete -c track -n "__fish_track_using_subcommand todo; and not __fish_seen_subcommand_from add list update done delete next help" -f -a "done" -d 'Complete a TODO (merges worktree if exists)'
complete -c track -n "__fish_track_using_subcommand todo; and not __fish_seen_subcommand_from add list update done delete next help" -f -a "delete" -d 'Delete a TODO'
complete -c track -n "__fish_track_using_subcommand todo; and not __fish_seen_subcommand_from add list update done delete next help" -f -a "next" -d 'Move a TODO to the front (make it the next todo to work on)'
complete -c track -n "__fish_track_using_subcommand todo; and not __fish_seen_subcommand_from add list update done delete next help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c track -n "__fish_track_using_subcommand todo; and __fish_seen_subcommand_from next" -s h -l help -d 'Print help'
...
complete -c track -n "__fish_track_using_subcommand todo; and __fish_seen_subcommand_from help" -f -a "next" -d 'Move a TODO to the front (make it the next todo to work on)'
...
complete -c track -n "__fish_track_using_subcommand alias; and __fish_seen_subcommand_from set" -s f -l force -d 'Force overwrite if alias already exists on another task'
...
complete -c track -n "__fish_track_using_subcommand completion" -s d -l dynamic -d 'Generate dynamic completion script (with real-time data)'
complete -c track -n "__fish_track_using_subcommand completion" -s h -l help -d 'Print help'
complete -c track -n "__fish_track_using_subcommand _complete" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c track -n "__fish_track_using_subcommand config; and not __fish_seen_subcommand_from set-calendar show help" -s h -l help -d 'Print help'
complete -c track -n "__fish_track_using_subcommand config; and not __fish_seen_subcommand_from set-calendar show help" -f -a "set-calendar" -d 'Set Google Calendar ID for today task'
complete -c track -n "__fish_track_using_subcommand config; and not __fish_seen_subcommand_from set-calendar show help" -f -a "show" -d 'Show current configuration'
complete -c track -n "__fish_track_using_subcommand config; and not __fish_seen_subcommand_from set-calendar show help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c track -n "__fish_track_using_subcommand config; and __fish_seen_subcommand_from set-calendar" -s h -l help -d 'Print help'
complete -c track -n "__fish_track_using_subcommand config; and __fish_seen_subcommand_from show" -s h -l help -d 'Print help'
complete -c track -n "__fish_track_using_subcommand config; and __fish_seen_subcommand_from help" -f -a "set-calendar" -d 'Set Google Calendar ID for today task'
complete -c track -n "__fish_track_using_subcommand config; and __fish_seen_subcommand_from help" -f -a "show" -d 'Show current configuration'
complete -c track -n "__fish_track_using_subcommand config; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c track -n "__fish_track_using_subcommand help; and not __fish_seen_subcommand_from new list switch status desc ticket archive todo link scrap sync repo alias llm-help completion _complete config webui help" -f -a "new" -d 'Create a new task and switch to it'
complete -c track -n "__fish_track_using_subcommand help; and not __fish_seen_subcommand_from new list switch status desc ticket archive todo link scrap sync repo alias llm-help completion _complete config webui help" -f -a "list" -d 'List tasks'
complete -c track -n "__fish_track_using_subcommand help; and not __fish_seen_subcommand_from new list switch status desc ticket archive todo link scrap sync repo alias llm-help completion _complete config webui help" -f -a "switch" -d 'Switch to a different task'
complete -c track -n "__fish_track_using_subcommand help; and not __fish_seen_subcommand_from new list switch status desc ticket archive todo link scrap sync repo alias llm-help completion _complete config webui help" -f -a "status" -d 'Show detailed information about the current task'
complete -c track -n "__fish_track_using_subcommand help; and not __fish_seen_subcommand_from new list switch status desc ticket archive todo link scrap sync repo alias llm-help completion _complete config webui help" -f -a "desc" -d 'View or set task description'
complete -c track -n "__fish_track_using_subcommand help; and not __fish_seen_subcommand_from new list switch status desc ticket archive todo link scrap sync repo alias llm-help completion _complete config webui help" -f -a "ticket" -d 'Link a ticket to a task'
complete -c track -n "__fish_track_using_subcommand help; and not __fish_seen_subcommand_from new list switch status desc ticket archive todo link scrap sync repo alias llm-help completion _complete config webui help" -f -a "archive" -d 'Archive a task'
complete -c track -n "__fish_track_using_subcommand help; and not __fish_seen_subcommand_from new list switch status desc ticket archive todo link scrap sync repo alias llm-help completion _complete config webui help" -f -a "todo" -d 'TODO management'
complete -c track -n "__fish_track_using_subcommand help; and not __fish_seen_subcommand_from new list switch status desc ticket archive todo link scrap sync repo alias llm-help completion _complete config webui help" -f -a "link" -d 'Link management'
complete -c track -n "__fish_track_using_subcommand help; and not __fish_seen_subcommand_from new list switch status desc ticket archive todo link scrap sync repo alias llm-help completion _complete config webui help" -f -a "scrap" -d 'Scrap (work notes) management'
complete -c track -n "__fish_track_using_subcommand help; and not __fish_seen_subcommand_from new list switch status desc ticket archive todo link scrap sync repo alias llm-help completion _complete config webui help" -f -a "sync" -d 'Sync repositories and setup task branches'
complete -c track -n "__fish_track_using_subcommand help; and not __fish_seen_subcommand_from new list switch status desc ticket archive todo link scrap sync repo alias llm-help completion _complete config webui help" -f -a "repo" -d 'Repository management'
complete -c track -n "__fish_track_using_subcommand help; and not __fish_seen_subcommand_from new list switch status desc ticket archive todo link scrap sync repo alias llm-help completion _complete config webui help" -f -a "alias" -d 'Task alias management'
complete -c track -n "__fish_track_using_subcommand help; and not __fish_seen_subcommand_from new list switch status desc ticket archive todo link scrap sync repo alias llm-help completion _complete config webui help" -f -a "llm-help" -d 'Show help optimized for LLM agents'
complete -c track -n "__fish_track_using_subcommand help; and not __fish_seen_subcommand_from new list switch status desc ticket archive todo link scrap sync repo alias llm-help completion _complete config webui help" -f -a "completion" -d 'Generate shell completion script'
complete -c track -n "__fish_track_using_subcommand help; and not __fish_seen_subcommand_from new list switch status desc ticket archive todo link scrap sync repo alias llm-help completion _complete config webui help" -f -a "_complete" -d 'Output completion candidates (hidden, for shell completion scripts)'
complete -c track -n "__fish_track_using_subcommand help; and not __fish_seen_subcommand_from new list switch status desc ticket archive todo link scrap sync repo alias llm-help completion _complete config webui help" -f -a "config" -d 'Configuration management'
complete -c track -n "__fish_track_using_subcommand help; and not __fish_seen_subcommand_from new list switch status desc ticket archive todo link scrap sync repo alias llm-help completion _complete config webui help" -f -a "webui" -d 'Start web-based user interface'
complete -c track -n "__fish_track_using_subcommand help; and not __fish_seen_subcommand_from new list switch status desc ticket archive todo link scrap sync repo alias llm-help completion _complete config webui help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c track -n "__fish_track_using_subcommand help; and __fish_seen_subcommand_from todo" -f -a "next" -d 'Move a TODO to the front (make it the next todo to work on)'
...
complete -c track -n "__fish_track_using_subcommand help; and __fish_seen_subcommand_from config" -f -a "set-calendar" -d 'Set Google Calendar ID for today task'
complete -c track -n "__fish_track_using_subcommand help; and __fish_seen_subcommand_from config" -f -a "show" -d 'Show current configuration'
